...
import {LoginUserInput, RegisterUserInput,UpdateProfileInput} from "../types/userTypes";
import jwt from "jsonwebtoken";

const registerUser = async (input:RegisterUserInput )=>{
    const { userName, firstName, lastName, email, password, phoneNumber, address } = input;
